...
class LATLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        # if perturbation is not None:
        #     contains_nan = torch.isnan(perturbation ).any()
        #     if contains_nan:
        #         print( "perturbation 张量中包含NaN值")
        #     else:
        #         print( "perturbation 张量中不包含NaN值")
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            if perturb_target == 'residuals' and perturb_layer == i:
                ...
                # contains_nan = torch.isnan(hidden_states ).any()
                # if contains_nan:
                #     print(i, "1hidden_states 张量中包含NaN值")
                # else:
                #     print(i, "1hidden_states 张量中不包含NaN值")
                if perturbation is not None:
                    hidden_states += perturbation.to(hidden_states.device)
                #     contains_nan = torch.isnan(perturbation ).any()
                #     if contains_nan:
                #         print(i, "2perturbation 张量中包含NaN值")
                #     else:
                #         print(i, "2perturbation 张量中不包含NaN值")
                # contains_nan = torch.isnan(hidden_states ).any()
                # if contains_nan:
                #     print(i, "after hidden_states 张量中包含NaN值")
                # else:
                #     print(i, "after hidden_states 张量中不包含NaN值")
            ...
            if self.gradient_checkpointing and self.training:
                ...
                if perturb_target in ['queries', 'keys', 'values'] and perturb_layer == i:
                    ...
                    # contains_nan = torch.isnan(hidden_states ).any()
                    # if contains_nan:
                    #     print(i ,"input hidden_states 张量中包含NaN值")
                    # else:
                    #     print(i, "input hidden_states 张量中不包含NaN值")
            ...
            # contains_nan = torch.isnan(hidden_states ).any()
            # if contains_nan:
            #     print( "layer output hidden_states 张量中包含NaN值")
            # else:
            #     print( "layer output hidden_states 张量中不包含NaN值")
            if use_cache:
...
class LATLlamaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        assert perturb_target in ['residuals', 'queries', 'keys', 'values']
        # contains_nan = torch.isnan(attention_mask ).any()
        # if contains_nan:
        #     print("attention_mask张量中包含NaN值")
        # else:
        #     print("attention_mask张量中不包含NaN值")
        # if position_ids is not None:
        #     contains_nan = torch.isnan(position_ids ).any()
        #     if contains_nan:
        #         print("position_ids张量中包含NaN值")
        #     else:
        #         print("position_ids张量中不包含NaN值")
        # if past_key_values is not None:
        #     contains_nan = torch.isnan(past_key_values ).any()
        #     if contains_nan:
        #         print("past_key_values张量中包含NaN值")
        #     else:
        #         print("past_key_values张量中不包含NaN值")
        # if inputs_embeds is not None:
        #     contains_nan = torch.isnan(inputs_embeds ).any()
        #     if contains_nan:
        #         print("inputs_embeds张量中包含NaN值")
        #     else:
        #         print("inputs_embeds张量中不包含NaN值")  
        outputs = self.model(
            input_ids=input_ids,
            attention_mask=attention_mask,
            position_ids=position_ids,
