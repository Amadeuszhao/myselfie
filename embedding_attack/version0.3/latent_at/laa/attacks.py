...
class GDAdversary(torch.nn.Module):
    ...
    def __init__(self, dim, epsilon, attack_mask,embedding_space=None, device=None, dtype=None):
        super().__init__()
        self.device = device
        ...
        uap_path = "/root/autodl-tmp/at/uap_first_success_constraint/temp_attack.npy"
