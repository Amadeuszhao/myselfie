...
```
python gen_model_answer.py --model-path /root/autodl-tmp/adver/adver_train_model_layer16_1619_epsilon_16_steps_4_500/checkpoint-500 --model-id adver_1619 
python gen_model_answer.py --model-path /root/autodl-tmp/adver/adver_train_model_layer16_1618_epsilon_12_steps_4_12000/checkpoint-12000 --model-id adver_1618_12000_epsilon_12
```
Arguments:
